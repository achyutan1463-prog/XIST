...
import random
import three #file with parameter sets,directly from matlab script
import json

a = three.a
p = [float(num_str) for line in a.splitlines() for num_str in line.split(',')]
no_intermediates = 10
...
q = sets(p,32)
table = [[None for _ in range(6)] for _ in range(300000)]
