...
for set in range (0,len(q)): #loop for each parameter set
 ...
 while j < 100:
    ...
    all_allelicstates.append(allelic_state) # will have 100 sublists at the ends, each sublist refers to a cell.Each sublist contains the allelic states at all timepoints 
    j += 1

 time = np.arange(0,tend+1,0.2)

 mean_allelicstates = np.round(np.mean(np.array(all_allelicstates), axis = 0))
 index_50 = np.searchsorted(time,50,side = 'right') - 1
 index_100 = np.searchsorted(time,100,side = 'right') - 1
 index_150 = np.searchsorted(time,150,side = 'right') - 1
 index_200 = np.searchsorted(time,200,side = 'right') - 1
 index_250 = np.searchsorted(time,250,side = 'right') - 1
 index_300 = np.searchsorted(time,300,side = 'right') - 1
 
 states_50.append(mean_allelicstates[index_50])  #each should have 20 values
 states_100.append(mean_allelicstates[index_100])
 states_150.append(mean_allelicstates[index_150])
 states_200.append(mean_allelicstates[index_200])
 states_250.append(mean_allelicstates[index_250])
 states_300.append(mean_allelicstates[index_300])
 # Plot 

total_values = len(states_50)

counts_4_50 = (states_50.count(4) / total_values) * 100
counts_3_50 = (states_50.count(3) / total_values) * 100
counts_2_50 = (states_50.count(2) / total_values) * 100
counts_1_50 = (states_50.count(1) / total_values) * 100
counts_0_50 = (states_50.count(0) / total_values) * 100

counts_4_100 = (states_100.count(4) / total_values) * 100
counts_3_100 = (states_100.count(3) / total_values) * 100
counts_2_100 = (states_100.count(2) / total_values) * 100
counts_1_100 = (states_100.count(1) / total_values) * 100
counts_0_100 = (states_100.count(0) / total_values) * 100

counts_4_150 = (states_150.count(4) / total_values) * 100
counts_3_150 = (states_150.count(3) / total_values) * 100
counts_2_150 = (states_150.count(2) / total_values) * 100
counts_1_150 = (states_150.count(1) / total_values) * 100
counts_0_150 = (states_150.count(0) / total_values) * 100

counts_4_200 = (states_200.count(4) / total_values) * 100
counts_3_200 = (states_200.count(3) / total_values) * 100
counts_2_200 = (states_200.count(2) / total_values) * 100
counts_1_200 = (states_200.count(1) / total_values) * 100
counts_0_200 = (states_200.count(0) / total_values) * 100

counts_4_250 = (states_250.count(4) / total_values) * 100
counts_3_250 = (states_250.count(3) / total_values) * 100
counts_2_250 = (states_250.count(2) / total_values) * 100
counts_1_250 = (states_250.count(1) / total_values) * 100
counts_0_250 = (states_250.count(0) / total_values) * 100

counts_4_300 = (states_300.count(4) / total_values) * 100
counts_3_300 = (states_300.count(3) / total_values) * 100
counts_2_300 = (states_300.count(2) / total_values) * 100
counts_1_300 = (states_300.count(1) / total_values) * 100
counts_0_300 = (states_300.count(0) / total_values) * 100

plt.bar('50', counts_0_50, width=0.2, label="XaXaXaXa", color="orange")
bottom_50 = counts_0_50
plt.bar('50', counts_2_50, width=0.2, label="XaXaXiXi", color="blue", bottom=bottom_50)
bottom_50 += counts_2_50
plt.bar('50', counts_1_50, width=0.2, label="XaXaXaXi", color="green", bottom=bottom_50)
bottom_50 += counts_1_50
plt.bar('50', counts_3_50, width=0.2, label="XaXiXiXi", color="red", bottom=bottom_50)
bottom_50 += counts_3_50
plt.bar('50', counts_4_50, width=0.2, label="XiXiXiXi", color="purple", bottom=bottom_50)

# Plotting for '100'
# Labels are omitted here to avoid duplicate entries in the legend.
plt.bar('100', counts_0_100, width=0.2, color="orange")
bottom_100 = counts_0_100
plt.bar('100', counts_2_100, width=0.2, color="blue", bottom=bottom_100)
bottom_100 += counts_2_100
plt.bar('100', counts_1_100, width=0.2, color="green", bottom=bottom_100)
bottom_100 += counts_1_100
plt.bar('100', counts_3_100, width=0.2, color="red", bottom=bottom_100)
bottom_100 += counts_3_100
plt.bar('100', counts_4_100, width=0.2, color="purple", bottom=bottom_100)

# Plotting for '150'
plt.bar('150', counts_0_150, width=0.2, color="orange")
bottom_150 = counts_0_150
plt.bar('150', counts_2_150, width=0.2, color="blue", bottom=bottom_150)
bottom_150 += counts_2_150
plt.bar('150', counts_1_150, width=0.2, color="green", bottom=bottom_150)
bottom_150 += counts_1_150
plt.bar('150', counts_3_150, width=0.2, color="red", bottom=bottom_150)
bottom_150 += counts_3_150
plt.bar('150', counts_4_150, width=0.2, color="purple", bottom=bottom_150)

# Plotting for '200'
plt.bar('200', counts_0_200, width=0.2, color="orange")
bottom_200 = counts_0_200
plt.bar('200', counts_2_200, width=0.2, color="blue", bottom=bottom_200)
bottom_200 += counts_2_200
plt.bar('200', counts_1_200, width=0.2, color="green", bottom=bottom_200)
bottom_200 += counts_1_200
plt.bar('200', counts_3_200, width=0.2, color="red", bottom=bottom_200)
bottom_200 += counts_3_200
plt.bar('200', counts_4_200, width=0.2, color="purple", bottom=bottom_200)

# Plotting for '250'
plt.bar('250', counts_0_250, width=0.2, color="orange")
bottom_250 = counts_0_250
plt.bar('250', counts_2_250, width=0.2, color="blue", bottom=bottom_250)
bottom_250 += counts_2_250
plt.bar('250', counts_1_250, width=0.2, color="green", bottom=bottom_250)
bottom_250 += counts_1_250
plt.bar('250', counts_3_250, width=0.2, color="red", bottom=bottom_250)
bottom_250 += counts_3_250
plt.bar('250', counts_4_250, width=0.2, color="purple", bottom=bottom_250)

# Plotting for '300'
plt.bar('300', counts_0_300, width=0.2, color="orange")
bottom_300 = counts_0_300
plt.bar('300', counts_2_300, width=0.2, color="blue", bottom=bottom_300)
bottom_300 += counts_2_300
plt.bar('300', counts_1_300, width=0.2, color="green", bottom=bottom_300)
bottom_300 += counts_1_300
plt.bar('300', counts_3_300, width=0.2, color="red", bottom=bottom_300)
bottom_300 += counts_3_300
plt.bar('300', counts_4_300, width=0.2, color="purple", bottom=bottom_300)


plt.xlabel("Time")
plt.ylabel("Number of occurrences")
plt.title("Tetraploid ( 4n , 4x )" + 'parameter set' + ' ' + str(set))
plt.legend()
plt.show()
print(all_allelicstates)