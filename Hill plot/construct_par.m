...
log10(0.01) log10(5);1 10;log10(0.01) log10(10);log10(0.0001) log10(1);0.2 3.5;1 1;0.01 5;... % p5-p11, xXF1
log10(0.01) log10(5);1 10;log10(0.01) log10(10);log10(0.0001) log10(1);0.2 3.5;1 1;0.01 5;... % p12-p18, xXF2
log10(0.01) log10(5);1 3;log10(0.01) log10(10);log10(0.0001) log10(1);0.2 3.5;1 1;0.01 5;... % p19-p25, xXF3
log10(0.01) log10(5);1 3;log10(0.01) log10(10);log10(0.0001) log10(1);0.2 3.5;1 1;0.01 5]; % p26-p32, xXF4
...
pars(:,[1,2,3,4,5,7,8,12,14,15,19,21,22,26,28,29]) = 10.^(pars(:,[1,2,3,4,5,7,8,12,14,15,19,21,22,26,28,29]));

%% Write parameter sets to output file
dlmwrite('/home/madhusud/modeling_gene_expression/Screens/three3.txt', pars);
